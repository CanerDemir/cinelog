...
void main() {
  group('SplashScreen Unit Tests', () {
    group('Animation Controller Tests', () {
      testWidgets('should initialize and render splash screen correctly',
      ...
      testWidgets('should dispose properly without errors',
          (WidgetTester tester) async {
        const config = SplashConfig();
      ...
      testWidgets('should handle animation initialization gracefully',
          (WidgetTester tester) async {
      ...
      testWidgets('should render animations correctly',
          (WidgetTester tester) async {
        const config = SplashConfig(
    ...
    group('Timer Functionality Tests', () {
      testWidgets('should set up navigation timer with correct duration',
          (WidgetTester tester) async {
        const config = SplashConfig(
      ...
      testWidgets('should handle timer cancellation on disposal',
          (WidgetTester tester) async {
        const config = SplashConfig(
      ...
      testWidgets('should handle timer setup errors gracefully',
          (WidgetTester tester) async {
    ...
    group('Navigation Triggering Tests', () {
      testWidgets('should navigate to home screen after display duration',
          (WidgetTester tester) async {
        const config = SplashConfig(
          displayDuration: Duration(milliseconds: 100),
        );
      ...
      testWidgets('should use custom fade transition for navigation',
          (WidgetTester tester) async {
        const config = SplashConfig(
          displayDuration: Duration(milliseconds: 50),
      ...
      testWidgets('should handle navigation errors with fallback',
          (WidgetTester tester) async {
        const config = SplashConfig(
          displayDuration: Duration(milliseconds: 50),
        );
      ...
      testWidgets('should skip splash screen in debug mode when configured',
          (WidgetTester tester) async {
        const config = SplashConfig(
          skipInDebug: true,
          displayDuration:
              Duration(seconds: 10), // Long duration that would be skipped
        );
      ...
      testWidgets('should not skip splash screen when skipInDebug is false',
          (WidgetTester tester) async {
        const config = SplashConfig(
          skipInDebug: false,
          displayDuration: Duration(milliseconds: 100),
    ...
    group('Responsive Sizing Tests', () {
      testWidgets(
          'should calculate logo size correctly for different screen sizes',
          (WidgetTester tester) async {
        const config = SplashConfig();
        ...
        await tester.binding
            .setSurfaceSize(const Size(414, 896)); // iPhone 11 size
        await tester.pumpWidget(
          MaterialApp(
            home: SplashScreen(config: config),
          ),
        ...
        expect(logoWidget2.size,
            equals(103.5)); // 414 * 0.25 = 103.5, within range

        // Test with large screen
        await tester.binding
            .setSurfaceSize(const Size(800, 1200)); // Tablet size
        await tester.pumpWidget(
          MaterialApp(
            home: SplashScreen(config: config),
          ),
        ...
        final logoWidget3 =
            tester.widget<CineLogLogo>(find.byType(CineLogLogo));
        expect(logoWidget3.size,
            equals(150.0)); // 800 * 0.25 = 200, clamped to max 150

        // Reset surface size
        await tester.binding.setSurfaceSize(null);
      });

      testWidgets('should handle landscape orientation constraints',
          (WidgetTester tester) async {
        const config = SplashConfig();
      ...
      testWidgets('should handle extreme screen sizes gracefully',
          (WidgetTester tester) async {
        const config = SplashConfig();
    ...
    group('Configuration Handling Tests', () {
      testWidgets('should use custom configuration parameters correctly',
          (WidgetTester tester) async {
        const config = SplashConfig(
      ...
      testWidgets('should handle debug configuration correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle production configuration correctly',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle fast configuration correctly',
          (WidgetTester tester) async {
    ...
    group('Error Handling Tests', () {
      testWidgets('should handle animation errors gracefully',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle widget disposal during animation gracefully',
          (WidgetTester tester) async {
        const config = SplashConfig(
      ...
      testWidgets('should handle mounted check correctly',
          (WidgetTester tester) async {
        const config = SplashConfig(
          displayDuration: Duration(milliseconds: 100),
        );
      ...
      testWidgets('should handle fallback display on critical errors',
          (WidgetTester tester) async {
